...
org.todesschaf.cacheUsage.setup = function() {
    ...
    var outFileName = "" + now.getUTCFullYear() + "_";
    if (month < 10) {
        outFileName += "0";
    }
    outFileName = outFileName + month + "_";

    if (dd < 10) {
        outFileName += "0";
    }
    outFileName = outFileName + dd + "_";

    if (hh < 10) {
        outFileName += "0";
    }
    outFileName = outFileName + hh + "_";

    if (mm < 10) {
        outFileName += "0";
    }
    outFileName = outFileName + mm + "_";
